...
\centering
\begin{subfigure}{2in}
\includegraphics[width=2in]{drawings/state_site_tensor-nut}
\end{subfigure}
\begin{subfigure}{2in}
\includegraphics[width=2in]{drawings/operator_site_tensor-nut}
\end{subfigure}
\caption{\label{fig:site-tensors-nut} Illustrations of the state and operator site tensors.}
\end{figure}

\begin{figure}\begin{center}
\includegraphics[width=\diagramwidth]{drawings/expectation_boundary_tensors-nut}
\caption{\label{fig:environment-tensors-nut} This diagram illustrates the environment tensors.}
\end{center}\end{figure}

\begin{figure}\begin{center}
\includegraphics[width=\diagramwidth]{drawings/expectation-nut}
